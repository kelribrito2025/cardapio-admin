 ...
 * Usa Stripe Connect com destination charges e taxa de 1,5% da plataforma.
 */

import Stripe from "stripe";
import { ENV } from "./_core/env";

// Taxa da plataforma: 1,5% sobre cada pagamento online
 ...
 * O pagamento vai para a conta do restaurante, com taxa de 1,5% para a plataforma
 */
export async function createOrderCheckoutSession(params: {
  ...
  // Calcular taxa da plataforma (1,5%)
