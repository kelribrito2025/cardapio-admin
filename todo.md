...
- [x] Bug: Passo "Configurar atendimento" do onboarding já vem marcado como concluído — removida criação automática de horários no backend + limpeza de horários residuais
