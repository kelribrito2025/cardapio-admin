...
## Importar Cardápio (Onboarding)
- [x] Botão "Importar cardápio" ao lado do botão "Novo item" na página Cardápio
- [x] Modal de importação com campo de URL e botão Importar
- [x] Backend: endpoint de scraping do link externo (fetch HTML)
- [x] Backend: parsing com LLM para extrair categorias, produtos, preços, complementos
- [x] Backend: inserção automática no banco (categorias, produtos, complementos, regras)
- [x] Frontend: barra de progresso real durante importação
- [x] Frontend: mensagem "não feche esta janela" durante importação
- [x] Frontend: mensagem de sucesso ao concluir e fechamento automático do modal
- [x] Proteção contra duplicação (mesmo link importado duas vezes)
