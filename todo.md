...
## Redesign da Página de Templates WhatsApp
- [x] Criar tabs horizontais no topo com nomes dos modelos (Novo Pedido, Preparando, Pronto, Finalizado)
- [x] Criar layout lado a lado: Editor à esquerda, Preview WhatsApp à direita
- [x] Implementar preview estilo bolha de mensagem WhatsApp (verde claro com horário)
- [x] Adicionar seção de variáveis disponíveis com badges clicáveis
- [x] Manter cores e visual do sistema atual (vermelho/branco)
