...
- [ ] Criar rodapé com duas colunas: card azul "Menu Premium" à esquerda e "Desenvolvido por Mindi" + "Fale comigo" à direita, tudo horizontal

## Rodapé do Cardápio Público
- [x] Redesenhar rodapé conforme imagem de referência
- [x] Layout de duas colunas horizontais
- [x] Card azul à esquerda com ícone de estrela e "Menu Premium"
- [x] Texto "Desenvolvido por Mindi" à direita
- [x] Link "Fale comigo" com ícone de mensagem
- [x] Manter altura compacta do rodapé

## Rodapé Minimalista com Check Verde
- [x] Alterar rodapé para estilo minimalista
- [x] Adicionar ponto azul pulsante
- [x] Texto "Criado e desenvolvido por" com nome em destaque
- [x] Ícone de check verde (CheckCircle2)
- [x] Borda superior azul
- [x] Link clicável para WhatsApp
