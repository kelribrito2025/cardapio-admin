...
import { Heart, Gift, Save, Coins, CreditCard, AlertTriangle, Check, Loader2 } from "lucide-react";
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight">Fidelização de Clientes</h1>
            <p className="text-sm text-muted-foreground">
              Configure estratégias para incentivar seus clientes a voltar e comprar novamente.
            </p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border shadow-sm p-6 space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="font-semibold text-base">Programa de Recompensas</h2>
              <p className="text-sm text-muted-foreground">
                Escolha e configure o programa de recompensas do seu restaurante. Você pode utilizar apenas um programa por vez.
              </p>
            </div>
          </div>
          ...
          {/* Seleção do programa ativo - Cards maiores */}
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <button
                ...
                className={cn(
                  "relative flex flex-col items-center gap-3 p-6 rounded-xl border-2 transition-all duration-200 hover:shadow-md",
                  rewardType === "none"
