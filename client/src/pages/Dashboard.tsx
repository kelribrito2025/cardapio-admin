  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        {/* Top Produtos */}
        <div className="bg-card rounded-xl border border-border/50 p-5 flex flex-col self-start">
          ...
          {topProductsLoading ? (
            ...
            <div className="space-y-4 overflow-y-auto pr-1" style={{ maxHeight: '306px' }}>
              {(() => {
