            ...
            {establishment.publicNote && establishment.publicNoteCreatedAt && (
              ...
              <div className="absolute -top-14 md:-top-16 left-0 z-20 animate-float-balloon">
                <div className="relative">
                  ...
                  {/* Bico do balão em formato de balão de pensamento - dois círculos centralizados */}
                  <div className="absolute -bottom-2.5 left-1/2 -translate-x-1/2 w-3.5 h-3.5 bg-white rounded-full border border-gray-200 shadow-sm"></div>
                  <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 w-2 h-2 bg-white rounded-full border border-gray-200 shadow-sm"></div>
                </div>
              </div>
            )}
