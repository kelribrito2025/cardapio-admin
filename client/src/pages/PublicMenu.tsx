        ...
        <div className="relative -mt-16 md:-mt-20 flex flex-col md:flex-row md:items-end gap-4 pb-4">
          ...
          <div className="relative z-10 ml-4 md:ml-6">
            ...
            {establishment.publicNote && establishment.publicNoteCreatedAt && (
              ...
              <div className="absolute -top-14 md:-top-16 left-1/2 -translate-x-1/2 z-20 animate-float-balloon">
                {/* Balão estilo Instagram com pontos redondos */}
                <div className="balao-nota text-center leading-tight break-words">
