    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 pt-4">
        <div className="relative h-48 md:h-64 lg:h-72">
          ...
          >
            {/* SVG clip path definition - curvas mais suaves e fluidas */}
            <svg className="absolute" width="0" height="0">
              <defs>
                <clipPath id="bannerClipMobile" clipPathUnits="objectBoundingBox">
                  {/* Recorte com curvas suaves e fluidas */}
                  <path d="M0,0 L1,0 L1,0.65 C0.92,0.65 0.88,0.75 0.88,0.85 C0.88,0.95 0.88,1 0.88,1 L0,1 Z" />
                </clipPath>
              </defs>
            </svg>
          ...
          {/* Ícones sociais embutidos no recorte - apenas mobile, sem containers */}
          {(establishment.whatsapp || establishment.instagram) && (
            <div className="md:hidden absolute bottom-1 right-1 flex items-end justify-center gap-2 pb-1 pr-1" style={{ width: '12%', height: '35%' }}>
