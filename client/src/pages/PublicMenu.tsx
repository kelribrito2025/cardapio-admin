    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 pt-4">
        <div className="relative h-48 md:h-64 lg:h-72">
          {/* Banner com recorte curvo para ícones sociais */}
          <div className="relative w-full h-full">
            {/* Imagem do banner com clip-path para criar o recorte */}
            <div 
              ...
              style={{
                clipPath: (establishment.whatsapp || establishment.instagram) 
                  ? 'path("M0,0 L100%,0 L100%,75% Q100%,85% 85%,85% L80%,85% Q70%,85% 70%,100% L0,100% Z")' 
                  : undefined
              }}
            >
