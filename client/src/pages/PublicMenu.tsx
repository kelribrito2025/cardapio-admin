...
function ProductCard({
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 overflow-hidden hover:border-gray-200 transition-colors cursor-pointer border-b-4 border-b-red-500">
      <div className="flex">
