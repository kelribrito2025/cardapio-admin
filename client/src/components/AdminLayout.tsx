              ...
              <Link href="/" className="flex items-center gap-3">
                {establishment?.logo ? (
                  <img 
                    ...
                    className="h-8 w-8 rounded-lg object-cover flex-shrink-0 ring-2 ring-red-200" style={{width: '37px', height: '37px'}}
                  />
                ) : (
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:flex relative">
                ...
                <Input
                  ...
                  className="w-[269px] pl-9 pr-0 h-9 text-sm bg-background border-border/50 rounded-lg focus:ring-2 focus:ring-primary/20"
                />
              </div>
            </div>
